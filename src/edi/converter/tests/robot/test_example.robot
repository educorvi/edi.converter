...
#
#  $ bin/test -s edi.converter -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src edi.converter.testing.EDI_CONVERTER_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/edi/converter/tests/robot/test_example.robot
#
